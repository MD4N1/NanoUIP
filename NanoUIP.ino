 ...
 */
const char led_red_str[]    PROGMEM = "Red Lamp";
const char led_yellow_str[] PROGMEM = "Yellow Lamp";
const char led_green_str[]  PROGMEM = "Green Lamp";
const char led_blue_str[]   PROGMEM = "Blue Lamp";
const char button_a_str[]   PROGMEM = "Main Gate";
const char button_b_str[]   PROGMEM = "Front Door";
const char button_c_str[]   PROGMEM = "Bedroom Door";
const char button_d_str[]   PROGMEM = "Bathroom Door";
const char analog_0_str[]   PROGMEM = "Sensor A";
const char analog_1_str[]   PROGMEM = "Sensor B";
const char analog_2_str[]   PROGMEM = "Sensor C";
const char analog_3_str[]   PROGMEM = "Sensor D";
const char analog_4_str[]   PROGMEM = "Sensor E";
const char analog_5_str[]   PROGMEM = "Sensor F";
